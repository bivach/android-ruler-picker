...
#### Ruler picker from kevalpatel2106 library with Decimal picker added. Android custom view that uses ruler for picking the number from given range.
...
- ### Gradle dependency: 
    - Add below dependency into your build.gradle file.
        ```groovy
        compile 'com.bivach:ruler-picker:1.5'
        ```
